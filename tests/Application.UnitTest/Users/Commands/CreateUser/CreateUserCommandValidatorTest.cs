...
namespace Application.UnitTest.Users.Commands.CreateUser
{
    internal class CreateUserCommandValidatorTest
    {
        ...
        [TestCase(null, "Email is required.", TestName = "Should fail validation when email is null")]
        [TestCase("", "Email is required.", TestName = "Should fail validation when email is empty string")]
        ...
        [TestCase(null, "Password is required.", TestName = "Should fail validation when password is null")]
        [TestCase("", "Password is required.", TestName = "Should fail validation when password is empty string")]

...
namespace Web.IntegrationTest.Controllers.WorkspaceApiControllerTests.Tests
{
    ...
    internal class GetWorkspaceByIdTest : WorkspaceApiControllerWithStoredWorkspaceTestBase
    {
        ...
        public async Task GetById_UnauthorizedUser_ShouldReturnUnauthorizedResponse()
        {
            ...
            HttpResponseMessage response = await WorkspaceApiClient.GetByIdHttpResponseAsync(new GetWorkspaceByIdRequest { Id = WorkspaceId });
        ...
        {
            HttpResponseMessage response = await WorkspaceApiClient.GetByIdHttpResponseAsync(new GetWorkspaceByIdRequest { Id = invalidId });
        ...
        public async Task GetById_WorkspaceIsNotFound_ShouldReturnErrorMessage()
        {
            ...
            HttpResponseMessage response = await WorkspaceApiClient.GetByIdHttpResponseAsync(new GetWorkspaceByIdRequest { Id = nonExistingWorkspaceId });
